...
clean:
	...
	@rm -f gcprinter.js gcprinter.min.js
	@rm -rf lib
...
#
# Target for `gcprinter.js` file.
#

gcprinter.js: node_modules $(SRC)
	@$(DUO) --use duo-coffee src/index.coffee > gcprinter.js
	@$(MINIFY) gcprinter.js --output gcprinter.min.js
